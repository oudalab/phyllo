...
def parsecase1(ptags, c, colltitle, title, author, date, URL):
    ...
    for p in ptags:
        ...
        if len(text) <= 0 or text.startswith('Tacitus\n'):
            continue
...
def main():
    ...
    collURL = 'http://www.thelatinlibrary.com/tac.html'
    ...
    with sqlite3.connect('texts.db') as db:
        ...
        c.execute("DELETE FROM texts WHERE author='Tacitus'")
        for url in textsURL:
