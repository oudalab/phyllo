...
def parsecase2(ptags, c, colltitle, title, author, date, URL):
    ...
    for p in ptags:
        ...
        if len(text) <= 0 or text == '' or text.isspace():
            continue
        passage = text
        chapter+=1
...
# main code
def main():
    collURL = 'http://www.thelatinlibrary.com/calpurniusflaccus.html'
    ...
    with sqlite3.connect('texts.db') as db:
        ...
        c.execute("DELETE FROM texts WHERE author='Calpurnius Flaccus'")
        for url in textsURL:
